...
const ProjectCard = ({title, description, image, tech, github, live}) => {
  return (
      <div className="p-10 rounded-3xl bg-[linear-gradient(145deg,#1e2024,#23272b)] hover:bg-[linear-gradient(to_right_bottom,#212428,#16181c)] transition-all duration-300 shadow-[10px_10px_19px_#1c1e22,-10px_-10px_19px_#262a2e]">
        ...
        <div className="p-5">
          ...
          <a href="" className="font-normal text-md text-gray-400 block mt-6">
            Live Demo: {live}
          </a>
          <a href="" className="font-normal text-md text-gray-400 block mt-3">
            View Code: {github}
          </a>
        </div>
      </div>
