...
const Navbar = () => {
  ...
  <div className="flex items-center justify-between border-b border-gray-800 py-3 px-4">
    <a href="tel:+919570258922" className="text-gray-300 font-medium flex items-center text-sm">
      <IoCall className="mr-2 text-sm" />(+91) 9570258922
    </a>

    <a href="mailto:web.abhiacharya@gmail.com" className="text-gray-300 font-medium flex items-center text-sm">
  ...
  <div className="flex justify-between items-center py-3 px-4">
    ...
    <a
      href="/resume.pdf"
      download
      className="inline-flex items-center gap-2 px-4 py-3 text-sm font-medium gradient-primary text-primary-foreground rounded-lg"
    >
