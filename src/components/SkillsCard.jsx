  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-0">
      ...
      <div className="col-span-1 sm:col-span-2 lg:col-span-1">
        <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-primary font-bold font-display mb-4 animate-fade-in color-primary">Technical Skills</h1>
        <p className="color-secondary text-sm sm:text-base tracking-wide leading-6 sm:leading-7">
